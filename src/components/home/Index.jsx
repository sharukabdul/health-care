              ...
              <Grid container justifyContent="center" sx={{ flex: 1 }}>
                {navItems.map((item) => (
                  <Grid item key={item.label}>
                    <Button href={item.href} color="inherit" sx={{ mx: 1 }}>
                      {item.label}
                    </Button>
                  </Grid>
                ))}
              ...
              <Grid container direction="column" spacing={3}>
                ...
                <Grid item>
                  ...
                  >
                    ...
                    professionals. We're here to support your wellness journey
        ...
        <Container maxWidth="lg">
          <Grid container direction="column" alignItems="center" sx={{ mb: 6 }}>
            ...
            <Grid item>
              ...
              >
                We're committed to providing exceptional care with a personal
                touch
              </FormLabel>
            </Grid>
          </Grid>
...
const services = [
  ...
  },
  {
    ...
    description:
      "Access to expert specialists across multiple medical disciplines.",
  },
  {
    icon: <Security className="h-6 w-6 text-primary" />,
    title: "Emergency Services",
    description:
      "24/7 emergency care with rapid response and expert treatment.",
  },
  {
    icon: <Event className="h-6 w-6 text-primary" />,
    title: "Scheduled Appointments",
    description:
      "Flexible scheduling with online booking for your convenience.",
  },
  {
    icon: <AccessTime className="h-6 w-6 text-primary" />,
    title: "Urgent Care",
    description:
      "Fast treatment for non-life-threatening conditions without appointment.",
  },
  {
    icon: <CheckCircle className="h-6 w-6 text-primary" />,
    title: "Preventive Care",
    description:
      "Regular check-ups and health assessments to keep you healthy.",
  },
];
